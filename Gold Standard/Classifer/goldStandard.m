...
for subjNum = 1: length (currentList)
   ...
   save_avw(mask, 'mask_prediction.nii.gz','f',scales2);   
   %ave_avw(mask2, ['mask_prediction_flair_subj' subjNum1 '.nii.gz'],'f',scales2);   
   %save_avw(mask3,['mask_prediction_combined_subj' subjNum1 '.nii.gz'],'f',scales2);   
